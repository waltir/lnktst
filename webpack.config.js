  ...
  return {
      ...
      plugins: [
        ...
        new webpack.DefinePlugin({
          ...
          'process.env.FIREBASEE_STOREAGE_BUCKET': JSON.stringify(process.env.FIREBASEE_STOREAGE_BUCKET),
          'process.env.FIREBASEE_MESSAGING_SENDER_ID': JSON.stringify(process.env.FIREBASEE_MESSAGING_SENDER_ID),
        })
      ],
