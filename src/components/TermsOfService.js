...
const TermsOfService = () => (
  ...
  <Grid fluid style={{marginTop: '-35px', marginLeft: '-16px', marginBottom: '0px'}}>
    <Row>
      <Col xs={12} lg={12}><img width="100%" height="250px" style={{width: 'auto', minWidth: '100vw', overflow: 'hidden', filter: 'grayscale(100%)', webkitFilter: 'grayscale(100%)'}} src="https://source.unsplash.com/2000x400/?san,francisco"/>
      </Col>
    </Row>
  </Grid>
